...
from ventasApp.utils import render_to_pdf,iniciar_excel, actualizar_excel
import time
...
def agregarpedidoVenta(request):
    ...
    if request.method=="POST":
        ...
        #messages.success(request, "Tiempo de ejecucion : " + tiempo_ejecucion  )
        fecha_actual = datetime.datetime.now().strftime("%Y-%m-%d")
        actualizar_excel(fecha_actual,tiempo_ejecucion)
